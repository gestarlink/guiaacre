      ...
      <div className="md:hidden">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link to="/buscar" className="h-9 w-9 rounded-full bg-white/10 flex items-center justify-center">
            ...
            <button className="w-full flex items-center justify-between rounded-2xl bg-card shadow-elevated px-4 py-3 border border-border/60 active:scale-[0.99] transition">
              <div className="flex items-center gap-2">
                ...
                <div className="text-sm text-left">
                  ...
                  <span className="text-muted-foreground"> · {selected?.city ?? "Rio Branco"}</span>
                </div>
              </div>
